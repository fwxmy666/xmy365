...
<html>
  <head>
  	<title>设置成功 | 香满圆-西部农产品电商平台,重庆菜园坝水果市场荣誉出品</title>
<meta charset="utf-8">
...
<style type="text/css">
	...
	.form-group{height:auto;}
	 ...
	 .message ol li{margin:50px auto;}
</style>
</head>
 	...
 	<div class="container"  style="background-color: #fff;">
	    <div class="register w-1250">
	        <div class="step clearfix  gutter-mar">
	            <div class="col-50"><span><i class="iconfont">&#xe62e;</i></span>设置新密码</div>
	...
	<center>
        <div class="message">
            <ol style="list-style:none;font-size:30px;">
                <li style="color:green;">恭喜您,修改成功!&nbsp;&nbsp;<span id="number">5</span>秒后自动跳转登录页面</li>
                <li><a href="/home/login" style="color:black;">点击登录香满圆电商平台</a></li>
            </ol>
        </div>
    </center>
