...
<nav>
 	...
 	<div class="container"  style="background-color: #fff;">
	    ...
	    <div class="register clearfix w-1250"  style="background-color: #fff;">
	        <div class="form-group col-50 clearfix">
	            <label for="name">用户名</label><div class="wrap-input clearfix"><input type="text" placeholder="请使用手机号作为用户名" name="name" id="name" required></div>
	        </div>
	        <div class="form-group col-50 clearfix">
	    ...
	    <input type="hidden" name="token" value="BEE1B807109D42E3B5597E182E1A8FCE" />
	    </form>
	    <!--第二步-->
	</div>
	...
	<div class="modal check-coded">
	    ...
	    <div class="modal-content">
	        ...
	        <div class="check-check"><div id="img_code" style="height:35px;width:122px;"><img src="/homelogin/picture/50846136eefc48b09c6a897c5e435917.gif" style="width:120px;border:1px solid #555;"/></div><span class="trans">换一个</span></div>
    ...
    <div class="detailss">
        <ul class="detailss-ul">
            ...
            <li class="detailss-li last-li clearfix">
                <p class="img-wrapp first"><img src="/homelogin/picture/b2cwx_1.jpg"><span class="color-green text-center">扫码下载APP</span></p>
                <p class="img-wrapp"><img src="/homelogin/picture/b2cpc_1.png"><span class="color-green">扫码进入移动端</span></p>
            </li>
            <div style="clear: both;"></div>
        </ul>
      <!--   <div class="logo-wrap">
            <img src="/homelogin/picture/logopic_1.png" alt="">
        </div> -->
    </div>
...
<script type="text/javascript" src="/homelogin/js/goods_search_1.js"></script>
  	...
  	<script type="text/javascript" src="/homelogin/js/drag_1.js"></script>
  	<script type="text/javascript" src="/homelogin/js/jquery.validate.min_1.js"></script>
  	<script type="text/javascript" src="/homelogin/js/additional-methods.min_1.js"></script>
  	<script type="text/javascript" src="/homelogin/js/jquery-form_1.js"></script>
	<script type="text/javascript" src="/homelogin/js/register_1.js"></script>
  </body>
</html>
