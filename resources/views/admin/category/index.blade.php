...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        ...
        <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
            <thead>
                <tr role="row">
                	...
                	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 247px;" aria-label="Platform(s): activate to sort column ascending">父级</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
        		...
        		">
                    <td class="">{{$v->tid}}</td>
                    <td class="uname">{{$v->tname}}</td>
                    <td class=" ">{{getName($v->pid)}}</td>
                    <td class=" ">{{$v->path}}</td>
                  
                    <td class=" ">
                    	<a href="/admin/category/{{$v->tid}}/edit"><button class='btn btn-primary'>修改</button></a>
